      ...
      <div class="h-full p-6">
        <ul class="">
          ...
          >
            ...
            >
              <img
                class="w-1/3 inline ml-3 p-2 self-center"
                :src="leader.badgeUrl"
              ...
              <div class="px-6 py-4">
                ...
                <div class="text-md mb-1">Scored {{ leader.score }}</div>
              </div>
            </div>
          </li>
        </ul>
...
export default {
  ...
  methods: {
    getLeadersApi() {
      let storedValue = localStorage.getItem('skilledLeaders');
      let me = 1;
      if (me == 2) {
        ...
        .then((response) => {
          ...
          localStorage.setItem('skilledLeaders', response.data);
        })
        .catch((error) => {
          console.error(error);
        });
    ...
    otherLeaders() {
      this.$router.push('/leaders/learning');
    },
  },
  mounted() {
    this.getLeadersApi();
